...
public:
  ...
  /*
  revise it to now we don't need to use addCard class function in BJackDealer
  */
  //void addCard(void);
  ...
  /*
  revise it to now we don't need to use openFirstCard class function in BJackDealer
  */
  //void openFirstCard();
  ...
  /*
  revise it to now we don't need to use showCards class function in BJackDealer
  */
...
private:
  ...
  /*
  revise it to now we don't need to use has-a class member 
  */
  //BJackPlayer dealer;
